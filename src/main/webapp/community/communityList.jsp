...
<body>
	<div class="search-div">
		<select id="selSearch" style="width: 100px;height: 30px;">
		...
		<textarea style="width: 350px;height: 30px;"></textarea>
			...
			<%}else{
				...
				{%>
					<tr>
						...
						<td>
							<a style="color: black;" 
						href="detail.jsp?num=<%=dto.getIdx()%>&currentPage=<%=currentPage%>&key=list">
						<%=dto.getSubject()%>
						</a>
						</td>
						<td>--</td>
