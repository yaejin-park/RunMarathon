...
<div class="admin-area">
	...
	<div class="contest-list">
		<div class="btn-wrap">
			<a href="./index.jsp?go=admin/contest/addContest.jsp&menu_one=<%=menu_one%>&menu_two=<%= menu_two%>" class="btn btn-info add-btn btn-add">추가</a>
			<a href="javascript:" class="btn btn-info delete-btn btn-del">삭제</a>
		</div>
