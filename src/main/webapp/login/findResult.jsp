...
$(function() {
	...
	%>
		...
		b+='<button type="button" id="findPass" class="btn btn-default" style="width: 412px; height: 45px; margin: 10px; border: 2px grey solid" value="yes">아이디/비밀번호 찾기</button>';
		$("#findBtn").html(b);
	<%}%>
...
<body>
<form action="index.jsp?go=login/loginForm.jsp" method="post" class="form-inline">
